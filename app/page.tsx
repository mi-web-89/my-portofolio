...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center">
      {/* profile */}
      <section className="flex flex-col items-center justify-center space-y-4 border border-amber-800 py-4 px-1">
        <Avatar src={defaultAvatar} size={168} alt="User Avatar" />
